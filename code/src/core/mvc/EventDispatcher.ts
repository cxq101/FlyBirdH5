export class EventDispatcher {
     ...
     */
    on(type: string, caller: any, listener: Function, args?: any[], onceOnly: boolean = false, priority: number = 0, overBefore: boolean = true): EventDispatcher {
     ...
     * @return 此 CustomEventDispatcher 对象。
     */
    once(type: string, caller: any, listener: Function, args?: any[], priority: number = 0): EventDispatcher {
