...
declare global {
    export namespace IEditor {
        ...
        export namespace IAssetStoreTools {
            ...
            function uploadPackage(resourceId: string, filePath: string, uploadProgress?: (loaded: number, total: number) => void, abortToken?: AbortToken): Promise<void>;
        }
        ...
        export interface IDataUtils {
            ...
            formatDataByType(data: any, typeDef: FTypeDescriptor): void;
        }
        ...
        export interface IEditorSingleton {
            ...
            createCustomSettings(name: string, location?: SettingsLocation, typeName?: string): void;
        ...
        export class InspectorPanel extends gui.Widget {
            ...
            allowUndo: boolean;
            stopTrace: boolean;
            readonly onDataChanged: Delegate<(sender: any, datapath: string[], value: any, oldvalue: any) => void>;
            constructor();
            onConstruct(): void;
            get history(): IDataHistory;
            resetInspectors(): void;
            inspect(data: any, type: string | FTypeDescriptor): void;
        ...
        const sharp: typeof import("sharp");
        const utils: ICryptoUtils & INativeTools & IUUIDUtils & IObjectUtils & IUtils & INetUtils & IDataUtils;
