declare module gui {
    ...
    */
    ...
    class Widget extends EventDispatcher {
        ...
        callLater(callback: Function, target?: any): void;
        cancelCallLater(callback: Function, target?: any): void;
        runCallLater(callback: Function, target?: any): void;
    ...
    class PopupManager {
        ...
        validatePopupPosition(popup: Widget, dir: PopupDirection): void;
        ...
        showTooltipsWin(tooltipWin: Widget, xx?: number, yy?: number): void;
        hideTooltips(): void;
        checkPopups(): void;
        private _touchBegin;
    }
    ...
    class Layout implements ILayout {
        ...
        private applyFlowX;
        private applyFlowY;
        protected getLayoutChildren(out: Array<Widget>): Widget[];
    ...
    class Prefab extends Resource {
        ...
        data: any;
        basePath: string;
        constructor(data: any, basePath?: string, deps?: Array<Resource>);
